    ...
    def create_questionnaire(self):
        ...
        for categoria, opciones in puntajes_dict.items():
            ...
            for opcion in opciones:
                ...
                tk.Radiobutton(self.frame_derecho, text=opcion, variable=selected_option,

                               value=opcion, command=lambda c=categoria, v=selected_option: self.aplicar_puntaje(c, v)).pack(anchor='w')
